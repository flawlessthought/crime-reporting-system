...
<html>
<head>
	<title>most wanted person log </title>
  ...
  if(isset($_POST['s'])){
    ...
    $reg="INSERT INTO `mostwanted`(`id`, `name`, `crime`, `password`) VALUES ('$p_id','$p_name','$spec','$p_pass')";
        ...
        {
          $message = "Most Wanted Person Added Successfully";
          echo "<script type='text/javascript'>alert('$message');</script>";
        }
    }
}
  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="viewmostwanted.php">Log Most Wanted</a></li>
	...
	<div class="center-container">
		 <div class="bg-agile">
			...
			<div class="login-form"><p>
                <h2>Log Wanted Person</h2><br>
      <form  method="post" style="color: gray">
   Most Wanted Person Name
					<input type="text"  name="incharge_name" placeholder="Person Name" required="" id="iname" onfocusout="f1()"/>
					Most Wanted Person Image
      <input type="file" name="img" value="" accept="image/*">
					<br>
         Crime:  
            <input style="background-color: #313131;color: white" type="text" name="crime" required/>
          <br>
          <!-- Password<input type="text"  name="password" placeholder="Password" required="" id="pas" onfocusout="f1()"/> -->
					<input type="submit" value="Submit" name="s">
          <br>
          <a href="viewmostwanted.php" class="btn btn-primary">View Added Most Wanted Person</a>
				</form>	
			</div>	
		</div>
	</div>	
