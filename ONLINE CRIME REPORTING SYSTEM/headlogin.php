...
<body style="color: black;background-image: url(OIP.jpg);background-size: 100%;background-repeat: no-repeat;back">
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h1 style="color:black; font-weight: bold">HQ Id</h1></label>
  ...
  <br>
  <br>
    <button class="btn btn-light"> <a href ="forgotpassword.php" >Forgot Password</a></button>
  </br></br>
</form>
  </div>
</div>
