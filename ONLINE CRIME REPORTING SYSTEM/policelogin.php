...
<body style="color: black;background-image: url(OIP.jpg);background-size: 100%;background-repeat: no-repeat;">
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h1 style="color:black; font-weight: bold">Police Id</h1></label>
  ...
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h1 style="color:black; font-weight: bold">Password</h1></label>
  ...
  <br>
  <br>
    <button class="btn btn-light"> <a href ="forgotpassword2.php" >Forgot Password</a></button>
  </br></br>
</form>
	</div>
</div>
