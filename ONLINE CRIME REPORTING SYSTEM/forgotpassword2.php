...
Email id <input type="text" name="email" class="form-control" id="email" placeholder="Email" required="">
<br>
<br> 
    New Password:  
...
$db=mysqli_connect("localhost","root","","crime_portal");
        ...
        {
            if(mysqli_query($db,"UPDATE police SET p_pass='$_POST[pass]' WHERE p_id='$_POST[email]' ;"))
            {
                ?>
                    <script type="text/javascript">
