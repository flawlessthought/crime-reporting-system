  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active" ><a href="head_case_details.php">View Complaints</a></li>
        <li class="active" ><a href="headviewmostwanted.php">Wanted</a></li>
        <li class="active" ><a href="head_view_missing_person.php">Missing person</a></li>
