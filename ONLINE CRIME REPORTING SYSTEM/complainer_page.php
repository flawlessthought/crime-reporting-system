		 ...
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<form action="#" method="post" style="color: gray">
					<!-- <input type="text"  name="aadhar_number" placeholder="CNIC Number" required="" disabled value=<?php echo "$a_no"; ?>> -->
					
				<div class="top-w3-agile" style="color: gray">Location of Crime
                    
                    <input name="location"   class="form-control" type="text" placeholder="Location Of Crime" required>
