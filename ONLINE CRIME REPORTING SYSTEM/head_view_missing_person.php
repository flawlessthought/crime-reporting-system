...
<head>
    ...
    $query="select id,name,location,date from missing_person";
     ...
     if(isset($_POST['s2']))
    {
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $q1=mysqli_query($conn,"delete from missing_person where id='$pid'");
...
<body>
  ...
  <div class="container">
   ...
   <a href="Missing_person.php" class="btn btn-primary">Add Missing Person</a>
 </div>
...
<div style="padding:50px;">
   <table class="table table-bordered">
    <thead class="thead-dark" style="background-color: black; color: white;">
      <tr>
        <th scope="col">Missing Person Id</th>
        <th scope="col">Missing person Name</th>
        <th scope="col">Last Location of Missing Person</th>
...
<form  action="" method="post">
  ...
  Missing Person Id
  <input class="form-control" type="text" name="pid" placeholder="Missing_person Id"><br>
