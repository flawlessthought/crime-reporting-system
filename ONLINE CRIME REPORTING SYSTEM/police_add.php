		 ...
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2>Log Police Officer</h2></p><br>	
				<form action="#" method="post" style="color: gray">Police Name
					...
					Police Id<input type="text"  name="police_id" placeholder="Email" required="" id="pid" onfocusout="f1()"/>
                    Specialist<input type="text"  name="police_spec" placeholder="Specialist" id="pspec" required onfocusout="f1()"/>
                    
                    Location of Police Officer<select name="location"   class="form-control">
    <option>Makupa</option>
    <option>Tononoka</option>
    <option>Central Police</option>
    <!-- <option>Kallar Sydan</option> -->
  </select>
